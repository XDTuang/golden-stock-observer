...
/* 2026-09-16 新闻池「更多」按钮（按日分组 · 每天收敛展示 DR_NEWS_SHOW_N 条后递增展开） */
.dr-more{cursor:pointer;font-size:12px;color:var(--blue);margin:3px 0 0;user-select:none}
...
<!-- 信息窗口条（2026-09-16）：由 drLoadWindow() 读 output/window_latest.json 渲染 -->
<div class="dr-card" id="drWindow"><p class="dr-note">信息窗口加载中…</p></div>
<!-- Tab: 投喂复盘 -->
