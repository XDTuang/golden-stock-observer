...
<div class="wrap">
  ...
  <!-- 算法规格说明（固定依据） -->
  <details>
    <summary>📐 判断依据 · 算法 · 策略规格（v1.0 固定版）</summary>
    <ul>
      <li><b>涨停口径</b>：主板 zdf≥9.9% / 创业板·科创板 zdf≥19.9% / 北交所 zdf≥29.5% / ST zdf≥4.9%，按 stock_type 区分</li>
      <li><b>情绪分</b>：S1 涨跌比(0→4 映射 0→100)×0.30 + S2 涨停(0→120)×0.25 + S3 指数均值(-2%→+3%)×0.20 + S4 主力净流入(-300→+300亿)×0.25</li>
      <li><b>状态机</b>：≥85 或 涨停≥120 或 涨跌比≥4 → 情绪过热预警；≥70 且 涨跌比≥2 → 强势普涨；≥55 → 结构强势；≥40 → 震荡分化；≥25 → 弱势回调；&lt;25 → 恐慌下跌</li>
      <li><b>仓位映射</b>：过热[30,50] / 强势[70,90] / 结构[60,75] / 震荡[40,60] / 弱势[25,40] / 恐慌[0,20]；单票≤10%、板块≤30%、回撤&gt;5%降半仓、情绪分≥85 禁追高</li>
      <li><b>候选四道关</b>：非ST → 当日涨幅&lt;8%（不追高）→ 主力净流入&gt;1亿 → 成交额&gt;5亿；入选为观察池，回踩MA5分批(2批)，破入场-5%或MA20止损</li>
      <li><b>风险雷达</b>：R1 情绪过热(红) / R2 资金背离·指数涨主力流出(红) / R3 板块资金集中度&gt;1.5(黄) / R4 涨跌比≥3.5(黄)</li>
      <li><b>数据源</b>：腾讯指数与全市场统计 / 东财板块资金 / 新浪 ETF（均为无密钥公开接口）</li>
    </ul>
  </details>

  <div class="foot">⚠️ 本页为「实时盯盘」预览版 · 判断与策略已固定（算法 v1.0）· 仅作数据展示，不构成投资建议 · 数据源：腾讯/东财/新浪公开行情</div>
</div>
